...
sap.ui.define([
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("UC").length, 1, "The sorting by UC returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by UC and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "Quantity");

		this.oGroupSortState.sort("UC");

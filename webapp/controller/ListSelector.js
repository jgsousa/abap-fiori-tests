sap.ui.define([
		...
		"use strict";
		return BaseObject.extend("CTT.Reabastecimento.controller.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias CTT.Reabastecimento.controller.ListSelector
			 */
			 ...
			 * @return {CTT.Reabastecimento.model.ListSelector} the list selector object for method chaining
			 * @public
			 */

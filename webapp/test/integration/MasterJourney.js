...
sap.ui.define([
	...
	opaTest("MasterList Filtering on Quantity less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog("<Quantity>").
			and.iSelectListItemInViewSettingsDialog("<100 <Unit>").
	...
	opaTest("MasterList Filtering on Quantity more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog(">100 <Unit>").
			and.iPressOKInViewSelectionDialog();

...
sap.ui.define([
		...
		"CTT/Reabastecimento/model/grouper",
		"CTT/Reabastecimento/model/GroupSortState"
		...
		return BaseController.extend("CTT.Reabastecimento.controller.Master", {
			...
			onSearch : function (oEvent) {
				...
				if (sQuery) {
					this._oListFilterState.aSearch = [new Filter("UC", FilterOperator.Contains, sQuery)];
				} else {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("CTT.Reabastecimento.view.ViewSettingsDialog", this);
			...
			onConfirmViewSettingsDialog : function (oEvent) {
				...
				aFilterItems.forEach(function (oItem) {
					switch (oItem.getKey()) {
						case "Filter1" :
							aFilters.push(new Filter("Quantity", FilterOperator.LE, 100));
							break;
						case "Filter2" :
							aFilters.push(new Filter("Quantity", FilterOperator.GT, 100));
							break;
						default :
							break;
					}

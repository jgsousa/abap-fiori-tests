sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("CTT/Reabastecimento/app", ".html");
		sHash = sHash || "";
		sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

		if (sHash) {
			sHash = "#Reabastecimento-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
		} else {
			sHash = "#Reabastecimento-display";
		}

		return sUrl + sUrlParameters + sHash;
	}

	return Opa5.extend("CTT.Reabastecimento.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["CTT/Reabastecimento/localService/mockserver"], function (mockserver) {
